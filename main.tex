...
\begin{longtable}{p{0.15\textwidth} p{0.17\textwidth} p{0.2\textwidth} p{0.13\textwidth} p{0.25\textwidth}}
	\caption{Fossil hominins with the potential to acquire - HSV2 from chimpanzee.\label{table:hsv2species}}\\
	
	% First page header
	\toprule
	Species &  Type specimen & 	Locations (type specimen) &  Age (000s BP) & Publication (suggesting a new species)\\ 
    \midrule
	\endfirsthead
	
	% Subsequent page headers
	\toprule
	\multicolumn{5}{l}{~\Cref{table:hsv2species} \textit{-- continued}}\\
	\midrule
	Species &  Type specimen & 	Locations (type specimen) &  Age (000s BP) & Publication (suggesting a new species)\\ 
	\midrule
	\endhead
